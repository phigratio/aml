...
/**
 * RULE 010: Increased Account Activity - Volume (Debtor).
 */
public class Rule010IncreasedAccountActivityVolumeDebtor implements Rule {

    private static final String RULE_ID = "010";
    private static final String RULE_NAME = "Rule 010: Increased Account Activity - Volume (Debtor)";
    private static final String TYPOLOGY = "Layering / Structuring / Unusual Activity Spike";
    private static final String REGULATORY_BASIS =
        "Tazama Rule 010 - Increased account activity: volume - debtor; FATF Red Flag Indicators; " +
    ...
    public RuleResult evaluate(Transaction transaction, CustomerContext customer, RuleContext context) {
        ...
        // Include current transaction in current-period calculations.
        ...
        if (historicalWindowTransactions.isEmpty()) {
            return buildNotTriggeredResult(transaction, customer, start, "Insufficient historical outgoing volume baseline");
        }
        ...
        evidence.put("current_volume", currentVolume);
        evidence.put("historical_volume_baseline", historicalAveragePerCurrentWindow);
        ...
        String recommendedAction = triggered
            ? "Investigate sudden outgoing volume spike against account baseline; verify source of funds and transfer rationale"
            : "No immediate action. Continue monitoring outgoing volume trends";
