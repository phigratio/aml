 ...
 */
public class Rule063SyntheticDataCheckBenfordsLawCreditor implements Rule {

    private static final String RULE_ID = "063";
    private static final String RULE_NAME = "Rule 063: Synthetic Data Check - Benford's Law - Creditor";
    private static final String TYPOLOGY = "Data Fabrication / Synthetic Inflows";
    private static final String REGULATORY_BASIS =
        "Tazama Rule 063 pattern; Benford forensic analytics for anomalous incoming distributions";
    private static final int RULE_PRIORITY = 68;
    ...
    public RuleResult evaluate(Transaction transaction, CustomerContext customer, RuleContext context) {
        ...
        List<Transaction> history = context.transactionHistoryProvider().findTransactions(
            transaction.accountNumber(), from, transaction.transactionDate(), Transaction.TransactionDirection.CREDIT
        );
        ...
        return RuleResult.builder()
            ...
            .recommendedAction(triggered
                ? "Investigate potential synthetic or fabricated incoming transaction amounts"
